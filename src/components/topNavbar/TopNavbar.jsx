        ...
        bg-gradient-to-t from-gray-300 to-[#ffddaa] fixed w-full top-0  z-40 '>
            <div className="left">
                ...
                <div className="flex justify-center mb-2">
                    <img className=" w-44 mt-2 " src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="LOGO" />
                </div>
            </div>
