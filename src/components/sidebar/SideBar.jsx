    ...
    return (
        <div className='  bg-gradient-to-t from-gray-500 to-[#F6E0BE] h-screen border-r '>
            ...
            <div className="flex justify-center">
                <img className=' w-52 mt-10' src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="LOGOx" />
            </div>
